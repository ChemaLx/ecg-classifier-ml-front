...
@Injectable()
export class FakeApiRegistroInterceptor implements HttpInterceptor {
  ...
  intercept(request: HttpRequest<unknown>, next: HttpHandler): Observable<HttpEvent<unknown>> {
    ...
    switch (true) {
      // lista
      case url.endsWith('/usuarios/usuario/guardar') && method === 'POST':
...
export const fakeRegistroinInterceptor = {
  provide: HTTP_INTERCEPTORS,
  useClass: FakeApiRegistroInterceptor,
  multi: true
}